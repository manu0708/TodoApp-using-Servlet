...
<body>
	...
	<div style="display: flex;margin-top: 70px;justify-content: space-evenly;align-items: center;flex-direction: column;min-height: 80vh;">
		<form action="edit-task" method="post" style="padding:30px;height:280px;width:350px; display: flex;justify-content: space-between;align-items: center;flex-direction: column;gap:20px;box-shadow: 0px 0px 10px rgb(85, 26, 139);">
			<div class="form-header" style="flex-basis: 10%">
				<h2 style="color: rgb(85, 26, 139);">Edit Task</h2>
			</div>
			<div class="form-body" style="flex-basis: 50%;width:100%; display: flex;justify-content: space-between;align-items: center;flex-direction: column;">
				<input type="hidden" name="task-id" value="<%= request.getParameter("id") %>">
